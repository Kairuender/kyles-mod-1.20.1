...
public enum ModArmorMaterials implements ArmorMaterial {
    VOID("void", 40, new int[]{ 3, 8, 6, 3}, 25,
            SoundEvents.BLOCK_SCULK_PLACE, 4f, 0.1f, () ->Ingredient.ofItems(ModItems.Void_Shard)),
    MASK("mask", 40, new int[]{ 3, 8, 6, 3}, 25,
    SoundEvents.BLOCK_BONE_BLOCK_BREAK, 4f, 0.1f, () ->Ingredient.ofItems(ModItems.Void_Shard));
    ...
    public String getName() {
        return KylesMod.MOD_ID + ":" + this.name;
    }
